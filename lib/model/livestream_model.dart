...
Livestreammodel livestreammodelFromJson(String str) => Livestreammodel.fromJson(json.decode(str));

String livestreammodelToJson(Livestreammodel data) => json.encode(data.toJson());
